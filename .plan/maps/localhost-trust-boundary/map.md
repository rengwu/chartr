...
- **The denial page, which 03 has now produced a need for.** An operator whose cookie
  ...
  fetches after admission — and 06 hardens that into a constraint: it is **rendered by
  the gate and never registered on the mux**, or the empty exemption list stops being
  empty.

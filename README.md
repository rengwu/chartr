...
- **Tools beside your terminals** — Agent, Skills, and Wayfinder are bundled.
  Install additional web and hosted plugins, including the Browser surface.
...
bundled Agent, Skills, and Wayfinder surfaces are implemented. CI builds and
tests the workspace and native plugin example on macOS and Ubuntu.

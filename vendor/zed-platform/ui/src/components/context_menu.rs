...
impl ContextMenu {
    ...
    /// Overrides the default menu height limit of 75% of the host window.
    /// This is useful when the context menu is itself hosted by a
    /// content-sized popup window.
    pub fn max_height(mut self, height: DefiniteLength) -> Self {
            ...
            WithRemSize::new(ui_font_size)
                ...
                .child(
                    v_flex()
                        ...
                        .when(self.max_height.is_none(), |this| {
                            this.max_h(vh(0.75, window))
                        })
                        .flex_shrink_0()

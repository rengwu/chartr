...
use crate::{
    BlockContext, BlockProperties, ContentMode, TerminalMode, TerminalVerticalAlignment,
    TerminalView,
};
                ...
                let (mut dimensions, line_height_px) = {
                    ...
                    if matches!(self.terminal_view.read(cx).mode, TerminalMode::Standalone) {
                        let should_anchor_to_bottom = {
                            ...
                            terminal_view.vertical_alignment
                                == TerminalVerticalAlignment::BottomWhenFull

...
//#endregion
//#region node_modules/@xterm/addon-ligatures/lib/addon-ligatures.js
var require_addon_ligatures = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/*! For license information please see addon-ligatures.js.LICENSE.txt */
	(function(e, t) {
		"object" == typeof exports && "object" == typeof module ? module.exports = t(require_browser_external_fs(), require_browser_external_path(), require_browser_external_util(), require_browser_external_stream()) : "function" == typeof define && define.amd ? define([
			"fs",
			"path",
			"util",
			"stream"
		], t) : "object" == typeof exports ? exports.LigaturesAddon = t(require_browser_external_fs(), require_browser_external_path(), require_browser_external_util(), require_browser_external_stream()) : e.LigaturesAddon = t(e.fs, e.path, e.util, e.stream);
	})(self, ((e, t, n, s) => (() => {
		var o = {
			185: (e, t) => {
				"use strict";
			...
			98: (e, t, n) => {
				...
				class h {
					constructor(e, t) {
						...
						const n = (this._font.tables.gsub && this._font.tables.gsub.features.filter(((e) => "calt" === e.tag)) || []).reduce(((e, t) => [...e, ...t.feature.lookupListIndexes]), []), s = this._font.tables.gsub && this._font.tables.gsub.lookups || [], a = s.filter(((e, t) => n.some(((e) => e === t))));
								...
								case 6:
									for (const [e, o] of t.subtables.entries()) switch (o.substFormat) {
										...
										case 2:
											...
											break;
										case 3: n.push(c.default(o, s, e));
									}
									break;
								case 8: for (const [e, s] of t.subtables.entries()) n.push(p.default(s, e));
							}
			...
			233: (e, t) => {
				...
				function o(e, t) {
					...
					if (e[0] < t[1] && t[0] < e[1]) n.both = a(Math.max(e[0], t[0]), Math.min(e[1], t[1]));
					if (e[0] < t[0]) {
				...
				t.default = function(e, t, n) {
					...
					for (const { glyphId: s, index: i } of a) {
						...
						if (a) for (const [e, i] of a.entries()) {
							...
							for (const [e, n] of i.input.entries()) a = o.processInputPosition([n], e + 1, a, i.lookupRecords, t);
							for (const e of i.lookahead) a = o.processLookaheadPosition([e], a);
							for (const e of i.backtrack) a = o.processBacktrackPosition([e], a);
							for (const { entry: t, substitutions: s } of a) t.lookup = {
								substitutions: s,
								length: i.input.length + 1,
								index: n,
								subIndex: e,
								contextRange: [-1 * i.backtrack.length, 1 + i.input.length + i.lookahead.length]
							};
						}
					}
					return r;
						...
						for (const [s, l] of o.entries()) {
							...
							if (o) for (const [l, u] of o.entries()) {
								...
								for (const { entry: e, substitutions: t } of c) e.lookup = {
									...
									contextRange: [-1 * u.backtrack.length, 1 + u.input.length + u.lookahead.length]
								};
								i.push(o);
							}
						}
			...
			91: (e, t) => {
				...
				Object.defineProperty(t, "__esModule", { value: !0 }), t.default = function(e, t) {
					return 2 === e.format ? Array.isArray(t) ? function(e, t) {
						...
						for (; r < t[1];) n(e, r) !== o && (r - s <= 1 ? a.set(s, o) : a.set([s, r], o)), r++;
						return r - s <= 1 ? a.set(s, o) : a.set([s, r], o), a;
					}(e, t) : /* @__PURE__ */ new Map([[t, n(e, t)]]) : /* @__PURE__ */ new Map([[t, null]]);
				}, t.listClassGlyphs = function(e, t) {
					if (2 === e.format) {
						const n = [];
						for (const s of e.ranges) s.classId === t && (s.end === s.start ? n.push(s.start) : n.push([s.start, s.end + 1]));
						return n;
					}
					return [];
				};
			...
			603: (e, t, n) => {
				...
				function o(e, t) {
					...
					switch (e.substFormat) {
						...
						case 2: return null != e.substitute[n] ? e.substitute[n] : null;
					}
				}
				t.getRangeSubstitutionGlyphs = function(e, t) {
					let n = t[0], s = o(e, n), r = t[0] + 1;
					const a = /* @__PURE__ */ new Map();
					for (; r < t[1];) o(e, r) !== s && (r - n <= 1 ? a.set(n, s) : a.set([n, r], s)), r++;
					return r - n <= 1 ? a.set(n, s) : a.set([n, r], s), a;
				}, t.getIndividualSubstitutionGlyph = o;
			},
			694: (e, t) => {
				"use strict";
				Object.defineProperty(t, "__esModule", { value: !0 }), t.default = function e(t, n, s, o) {
					let r = t[n[o]];
					if (!r) return;
					let a = r.lookup;
					if (r.reverse) {
			...
			814: (e, t, n) => {
				...
				t.name = function(e, t) {
					...
					if (e.os2) switch (e.os2.panose[0]) {
						case 2: return 9 === e.os2.panose[3] ? o.Monospace : e.os2.panose[1] >= 11 && e.os2.panose[1] <= 15 || 0 === e.os2.panose[1] ? o.SansSerif : o.Serif;
						case 3: return o.Cursive;
					}
			...
			781: function(e, t, n) {
				...
				async function l(e) {
					const t = Object.assign({
						concurrency: 4,
						language: "en"
					}, e), a = await async function(e, n, s) {
						const o = [];
						let a = 0;
						const i = async (e) => {
					...
					}(0, await o.default({ extensions: ["ttf", "otf"] }), t.concurrency), i = {};
					for (let e of a.filter(((e) => e))) {
						const { name: t } = e, n = s(e, ["name"]);
						i[t] || (i[t] = []), i[t].push(n);
					}
					return i;
				}
						...
						(async () => {
							...
							try {
								switch (function(e) {
									...
									case c.Woff:
									default: throw new Error("provided font type is not supported yet");
								}
							} finally {
			...
			380: (e, t) => {
				...
				function u(e, t, n) {
					switch (e) {
						case 0: return a;
						case 1: return l[n] || i[t];
						case 3: if (1 === t || 10 === t) return a;
					}
				}
				t.default = function(e, t) {
			...
			980: (e, t) => {
				"use strict";
				Object.defineProperty(t, "__esModule", { value: !0 }), t.formatFixed = function(e, t) {
					return e + t / 65536;
			...
			459: (e, t, n) => {
				...
				const s = n(56), o = n(456), r = n(49), a = {
					win32: () => process.env.WINDIR ? [s.join(process.env.WINDIR, "Fonts")] : ["C:\\Windows\\Fonts"],
					darwin: () => {
						const e = o.homedir();
						return [
					...
					linux: () => {
						...
						return [
							...
							...e ? [s.join(e, ".fonts"), s.join(e, ".local/share/fonts")] : []
						];
					}
				};
				function i(e) {
			...
			593: (e, t, n) => {
				...
				e.exports = class {
					...
					reset() {
						this[u] && this[p] && this[p].length && this[p].forEach(((e) => this[u](e.key, e.value))), this[f] = /* @__PURE__ */ new Map(), this[p] = new s(), this[r] = 0;
					}
					dump() {
			...
			602: (e, t, n) => {
				...
				g.BYTE = function(e) {
					return f.argument(e >= 0 && e <= 255, "Byte value should be between 0 and 255."), [e];
					...
					return e >= -107 && e <= 107 ? [e + 139] : e >= 108 && e <= 1131 ? [247 + ((e -= 108) >> 8), 255 & e] : e >= -1131 && e <= -108 ? [251 + ((e = -e - 108) >> 8), 255 & e] : e >= -32768 && e <= 32767 ? g.NUMBER16(e) : g.NUMBER32(e);
				}, m.NUMBER = function(e) {
				...
				g.MACSTRING = function(e, t) {
					...
					for (; t < e.length;) {
						const s = e[t];
						t = 0 === s ? U(e, t, n) : s >= -128 && s <= 127 ? k(e, t, n) : T(e, t, n);
					}
					return n;
				}, g.INDEX = function(e) {
					let t = 1;
				...
				g.CHARSTRING = function(e) {
					...
					for (let r = 0; r < n; r += 1) {
						...
						void 0 === i && (i = n.value);
						const l = a(i);
						"TABLE" === n.type ? (o.push(t.length), t = t.concat([0, 0]), s.push(l)) : t = t.concat(l);
					}
				...
				_.prototype.parseByte = function() {
					...
					const t = P(this.data, this.offset + this.relativeOffset), n = P(this.data, this.offset + this.relativeOffset + 2);
					...
					for (let s = 0; s < n; s++) {
						const n = t[s];
						if (0 !== n) if (this.relativeOffset = n, e) {
				...
				function K(e) {
					switch (e.version) {
						...
						case 2:
							...
							for (let t = 0; t < e.numberOfGlyphs; t++) e.glyphNameIndex[t] < Y.length ? this.names[t] = Y[e.glyphNameIndex[t]] : this.names[t] = e.names[e.glyphNameIndex[t] - Y.length];
							break;
						case 2.5:
							this.names = new Array(e.numberOfGlyphs);
							for (let t = 0; t < e.numberOfGlyphs; t++) this.names[t] = Y[t + e.glyphNameIndex[t]];
							break;
						default: this.names = [];
					}
				}
					...
					if (e.numberOfContours = s.parseShort(), e._xMin = s.parseShort(), e._yMin = s.parseShort(), e._xMax = s.parseShort(), e._yMax = s.parseShort(), e.numberOfContours > 0) {
						...
						if (f.argument(o.length === n, "Bad flags."), t.length > 0) {
							...
							if (n > 0) {
								...
								let e = 0;
								for (let t = 0; t < n; t += 1) r = o[t], i = a[t], i.x = ee(s, r, e, 2, 16), e = i.x;
								let l = 0;
								for (let e = 0; e < n; e += 1) r = o[e], i = a[e], i.y = ee(s, r, l, 4, 32), l = i.y;
							}
							e.points = a;
						} else e.points = [];
					...
					if (t.isComposite) for (let n = 0; n < t.components.length; n += 1) {
						...
						if (o.getPath(), o.points) {
							...
							if (void 0 === s.matchedPoints) e = ne(o.points, s);
								...
								r = ne([r], a)[0], a.dx = n.x - r.x, a.dy = n.y - r.y, e = ne(o.points, a);
							}
				...
				const re = {
					...
					parse: function(e, t, n, s) {
						...
						for (let r = 0; r < n.length - 1; r += 1) {
							const a = n[r];
							a !== n[r + 1] ? o.push(r, ce.ttfGlyphLoader(s, r, te, e, t + a, oe)) : o.push(r, ce.glyphLoader(s, r));
						}
						return o;
					}
				};
				...
				ae.prototype.bindConstructorValues = function(e) {
					this.index = e.index || 0, this.name = e.name || null, this.unicode = e.unicode || void 0, this.unicodes = e.unicodes || void 0 !== e.unicode ? [e.unicode] : [], e.xMin && (this.xMin = e.xMin), e.yMin && (this.yMin = e.yMin), e.xMax && (this.xMax = e.xMax), e.yMax && (this.yMax = e.yMax), e.advanceWidth && (this.advanceWidth = e.advanceWidth), Object.defineProperty(this, "path", function(e, t) {
						let n = t || new u();
						return {
							configurable: !0,
							get: function() {
					...
					if (s.hinting && o && o.hinting && (a = this.path && o.hinting.exec(this, n)), a) r = re.getPath(a).commands, e = Math.round(e), t = Math.round(t), i = l = 1;
					else {
					...
					let o;
					t = void 0 !== t ? t : 0, n = void 0 !== n ? n : 0, s = void 0 !== s ? s : 24, o = 1 / this.path.unitsPerEm * s, e.lineWidth = 1, e.strokeStyle = "black", $(e, t, -1e4, t, 1e4), $(e, -1e4, n, 1e4, n);
					const r = this.xMin || 0;
					let a = this.yMin || 0;
					const i = this.xMax || 0;
					let l = this.yMax || 0;
					const u = this.advanceWidth || 0;
					e.strokeStyle = "blue", $(e, t + r * o, -1e4, t + r * o, 1e4), $(e, t + i * o, -1e4, t + i * o, 1e4), $(e, -1e4, n + -a * o, 1e4, n + -a * o), $(e, -1e4, n + -l * o, 1e4, n + -l * o), e.strokeStyle = "green", $(e, t + u * o, -1e4, t + u * o, 1e4);
				};
				const ie = ae;
				function le(e, t, n) {
				...
				function pe(e, t) {
					...
					if (Array.isArray(e) && Array.isArray(t)) {
						...
						for (let n = 0; n < e.length; n += 1) if (!pe(e[n], t[n])) return !1;
						return !0;
					}
					return !1;
				}
				...
				function ge(e, t, n) {
					...
					for (n = void 0 !== n ? n : e.length; s.relativeOffset < n;) {
						let e = s.parseByte();
						e <= 21 ? (12 === e && (e = 1200 + s.parseByte()), o.push([e, r]), r = []) : r.push(de(s, e));
					}
					return function(e) {
						const t = {};
						for (let n = 0; n < e.length; n += 1) {
				...
				function ye(e, t, n) {
					...
					for (let r = 0; r < t.length; r += 1) {
						...
						if (Array.isArray(a.type)) {
							...
							for (let s = 0; s < a.type.length; s++) o = void 0 !== e[a.op] ? e[a.op][s] : void 0, void 0 === o && (o = void 0 !== a.value && void 0 !== a.value[s] ? a.value[s] : null), "SID" === a.type[s] && (o = me(n, o)), t[s] = o;
							s[a.name] = t;
						} else o = e[a.op], void 0 === o && (o = void 0 !== a.value ? a.value : null), "SID" === a.type && (o = me(n, o)), s[a.name] = o;
					}
					return s;
				}
				const ve = [
				...
				function Ue(e, t, n, s) {
					...
					for (let r = 0; r < n.length; r += 1) {
						...
						if (0 !== i && 0 !== l) {
							...
							if (a._defaultWidthX = n.defaultWidthX, a._nominalWidthX = n.nominalWidthX, 0 !== n.subrs) a._subrs = he(e, l + n.subrs + t).objects, a._subrsBias = fe(a._subrs);
							a._privateDict = n;
						}
						o.push(a);
					}
				...
				function ke(e, t, n) {
					...
					return function n(u) {
						let f, U, k, T, E, w, O, I, R, L, B, C, D = 0;
						for (; D < u.length;) {
							let M = u[D];
							switch (D += 1, M) {
								case 1:
								...
								case 12:
									switch (M = u[D], D += 1, M) {
										...
										case 37:
											...
											break;
										default: console.log("Glyph " + t.index + ": unknown operator 1200" + M), l.length = 0;
									}
									break;
								case 14:
								...
								case 28:
									...
									break;
								case 29:
									E = l.pop() + e.gsubrsBias, w = e.gsubrs[E], w && n(w);
									break;
								case 30:
								...
								case 31:
									...
									break;
								default: M < 32 ? console.log("Glyph " + t.index + ": unknown operator " + M) : M < 247 ? l.push(M - 139) : M < 251 ? (f = u[D], D += 1, l.push(256 * (M - 247) + f + 108)) : M < 255 ? (f = u[D], D += 1, l.push(256 * -(M - 251) - f - 108)) : (f = u[D], U = u[D + 1], k = u[D + 2], T = u[D + 3], D += 4, l.push((f << 24 | U << 16 | k << 8 | T) / 65536));
							}
						}
				...
				function Te(e, t) {
					let n, s = j.indexOf(e);
					return s >= 0 && (n = s), s = t.indexOf(e), s >= 0 ? n = s + j.length : (n = j.length + t.length, t.push(e)), n;
				}
				function Ee(e, t, n) {
					const s = {};
					for (let o = 0; o < e.length; o += 1) {
						const r = e[o];
						let a = t[r.name];
						void 0 === a || pe(a, r.value) || ("SID" === r.type && (a = Te(a, n)), s[r.op] = {
							name: r.name,
							type: r.type,
							value: a
						});
				...
				const Re = {
					parse: function(e, t, n) {
						n.tables.cff = {};
						const r = he(e, he(e, function(e, t) {
							const n = {};
						...
						}(e, t).endOffset, z.bytesToString).endOffset), a = he(e, r.endOffset, z.bytesToString);
						n.gsubrs = he(e, a.endOffset).objects, n.gsubrsBias = fe(n.gsubrs);
						...
						const c = t + u.private[1], p = Se(e, c, u.private[0], a.objects);
						if (n.defaultWidthX = p.defaultWidthX, n.nominalWidthX = p.nominalWidthX, 0 !== p.subrs) n.subrs = he(e, c + p.subrs).objects, n.subrsBias = fe(n.subrs);
						...
						const h = function(e, t, n, s) {
							...
							n -= 1;
							const i = [".notdef"], l = a.parseCard8();
							if (0 === l) for (let e = 0; e < n; e += 1) o = a.parseSID(), i.push(me(s, o));
							else if (1 === l) for (; i.length <= n;) {
								o = a.parseSID(), r = a.parseCard8();
								for (let e = 0; e <= r; e += 1) i.push(me(s, o)), o += 1;
							}
							else {
						...
						0 === u.encoding ? n.cffEncoding = new J(X, h) : 1 === u.encoding ? n.cffEncoding = new J(V, h) : n.cffEncoding = function(e, t, n) {
							let s;
							...
							return new J(o, n);
						}(e, t + u.encoding, h), n.encoding = n.encoding || n.cffEncoding, n.glyphs = new ce.GlyphSet(n);
					...
					make: function(e, t) {
						...
						let l = we(o, i);
						n.topDictIndex = Oe(l), n.globalSubrIndex = new M.Record("Global Subr INDEX", [{
							name: "subrs",
							type: "INDEX",
							value: []
						...
						return o.charset = n.header.sizeOf() + n.nameIndex.sizeOf() + n.topDictIndex.sizeOf() + n.stringIndex.sizeOf() + n.globalSubrIndex.sizeOf(), o.encoding = 0, o.charStrings = o.charset + n.charsets.sizeOf(), o.private[1] = o.charStrings + n.charStringsIndex.sizeOf(), l = we(o, i), n.topDictIndex = Oe(l), n;
					}
				}, Le = {
					parse: function(e, t) {
				...
				function We(e, t, n) {
					switch (e) {
						case 0: return _e;
						case 1: return ze[n] || He[t];
						case 3: if (1 === t || 10 === t) return _e;
					}
				}
				function qe(e) {
					const t = {};
				...
				const Ve = {
					parse: function(e, t, n) {
						...
						for (let t = 0; t < a; t++) {
							const t = o.parseUShort(), r = o.parseUShort(), a = o.parseUShort(), l = o.parseUShort(), u = Ae[l] || l, c = o.parseUShort(), p = o.parseUShort(), f = Fe(t, a, n), h = We(t, r, a);
							if (void 0 !== h && void 0 !== f) {
								let t;
								if (t = h === _e ? d.UTF16(e, i + p, c) : d.MACSTRING(e, i + p, c, h), t) {
									let e = s[u];
					...
					make: function(e, t) {
						...
						const a = qe(Pe), i = qe(Ne), l = [], u = [];
						for (let e = 0; e < s.length; e++) {
							n = s[e];
							const r = o[n];
							for (let e in r) {
								const s = r[e];
								let o = 1, c = a[e], p = Ge[c];
								const f = We(o, p, c);
					...
					parse: function(e, t) {
						...
						switch (n.version = s.parseVersion(), n.italicAngle = s.parseFixed(), n.underlinePosition = s.parseShort(), n.underlineThickness = s.parseShort(), n.isFixedPitch = s.parseULong(), n.minMemType42 = s.parseULong(), n.maxMemType42 = s.parseULong(), n.minMemType1 = s.parseULong(), n.maxMemType1 = s.parseULong(), n.version) {
							...
							case 2:
								...
								n.names = [];
								for (let e = 0; e < n.numberOfGlyphs; e++) if (n.glyphNameIndex[e] >= Y.length) {
									const e = s.parseChar();
				...
				const et = {
					...
					parse: function(e, t) {
						...
						const o = n.parseULong(), r = {};
						for (let s = 0; s < o; s++) {
							const s = n.parseTag(), o = n.parseULong(), a = n.parseULong();
							r[s] = d.UTF8(e, t + o, a);
						}
						return r;
					},
				...
				function rt(e) {
					...
					t.searchRange = 16 * n, t.entrySelector = nt(n), t.rangeShift = 16 * t.numTables - t.searchRange;
					const s = [], o = [];
					...
					for (let t = 0; t < e.length; t += 1) {
						...
						const a = n.sizeOf(), i = ot(n.tableName, st(n.encode()), r, a);
						for (s.push({
				...
				const lt = function(e) {
					...
					const g = Le.make({
					...
					}), y = Me.make(e.glyphs.length), v = Ze.make({
						...
						ulCodePageRange1: 1,
						sxHeight: at(e, "xyvw", { yMax: Math.round(d.ascender / 2) }).yMax,
						sCapHeight: at(e, "HIKLEFJMNTZBDPRAGOQSUVWXY", d).yMax,
						usDefaultChar: e.hasChar(" ") ? 32 : 0,
						usBreakChar: e.hasChar(" ") ? 32 : 0
					}), b = Ce.make(e.glyphs), x = q.make(e.glyphs), S = e.getEnglishName("fontFamily"), U = e.getEnglishName("fontSubfamily"), k = S + " " + U;
					let T = e.getEnglishName("postScriptName");
					T || (T = S.replace(/\s/g, "") + "-" + U);
					const E = {};
					for (let t in e.names) E[t] = e.names[t];
					E.uniqueID || (E.uniqueID = { en: e.getEnglishName("manufacturer") + ":" + k }), E.postScriptName || (E.postScriptName = { en: T }), E.preferredFamily || (E.preferredFamily = e.names.fontFamily), E.preferredSubfamily || (E.preferredSubfamily = e.names.fontSubfamily);
					const w = [], O = Ve.make(E, w), I = w.length > 0 ? De.make(w) : void 0, R = Qe.make(), L = Re.make(e.glyphs, {
					...
					}), B = e.metas && Object.keys(e.metas).length > 0 ? tt.make(e.metas) : void 0, C = [
						g,
						m,
						y,
						v,
					...
					I && C.push(I), e.tables.gsub && C.push(et.make(e.tables.gsub)), B && C.push(B);
					const D = rt(C), M = st(D.encode()), A = D.fields;
					let P = !1;
					for (let e = 0; e < A.length; e += 1) if ("head table" === A[e].name) {
						A[e].value.checkSumAdjustment = 2981146554 - M, P = !0;
						break;
					}
					if (!P) throw new Error("Could not find head table with checkSum to adjust.");
					return D;
				};
				function ut(e, t) {
				...
				dt.prototype = ht.prototype, dt.prototype.getKerningValue = function(e, t, n) {
					for (let s = 0; s < e.length; s++) {
						...
						for (let e = 0; e < o.length; e++) {
							...
							if (!(r < 0)) switch (s.posFormat) {
								case 1:
									...
									break;
								case 2:
									const o = this.getGlyphClass(s.classDef1, t), a = this.getGlyphClass(s.classDef2, n), i = s.classRecords[o][a];
				...
				mt.prototype = ht.prototype, mt.prototype.createDefaultTable = function() {
					...
					if (u >= 0) {
						...
						for (let t = 0; t < e.length; t++) if (yt(e[t].components, i)) return;
						e.push(l);
					} else u = -1 - u, r.coverage.glyphs.splice(u, 0, a), r.ligatureSets.splice(u, 0, [l]);
					...
					switch (e) {
						case "aalt":
						case "salt": return "number" == typeof t.by ? this.addSingle(e, t, n, s) : this.addAlternate(e, t, n, s);
						case "dlig":
						case "liga":
						case "rlig": return this.addLigature(e, t, n, s);
					}
				};
				const bt = mt;
				function xt(e) {
				...
				const Dt = function(e) {
					...
					interpolate: function(e, t, n, s) {
						...
						o = s.distance(e, t, !0, !0), r = s.distance(e, n, !0, !0), l = s.distance(t, t, !1, !0), u = s.distance(n, n, !1, !0), a = Math.abs(o), i = Math.abs(r), c = a + i, 0 !== c ? Mt.setRelative(e, e, (l * i + u * a) / c, s, !0) : Mt.setRelative(e, e, (l + u) / 2, s, !0);
					},
					...
					interpolate: function(e, t, n, s) {
						...
						o = s.distance(e, t, !0, !0), r = s.distance(e, n, !0, !0), l = s.distance(t, t, !1, !0), u = s.distance(n, n, !1, !0), a = Math.abs(o), i = Math.abs(r), c = a + i, 0 !== c ? At.setRelative(e, e, (l * i + u * a) / c, s, !0) : At.setRelative(e, e, (l + u) / 2, s, !0);
					},
					normalSlope: 0,
					setRelative: function(e, t, n, s, o) {
						if (!s || s === this) return void (e.y = (o ? t.yo : t.y) + n);
						const r = o ? t.xo : t.x, a = o ? t.yo : t.y, i = r + n * s.x;
						e.y = a + n * s.y + s.normalSlope * (e.x - i);
					},
				...
				function Gt(e, t) {
					...
					return t /= n, 1 == (e /= n) && 0 === t ? Mt : 0 === e && 1 === t ? At : new Pt(e, t);
				}
				function Nt(e, t, n, s) {
				...
				Object.freeze(Mt), Object.freeze(At), Pt.prototype.distance = function(e, t, n, s) {
					return this.x * Mt.distance(e, t, n, s) + this.y * At.distance(e, t, n, s);
				...
				const Ft = Object.freeze(new Nt(0, 0)), _t = {
					cvCutIn: 17 / 16,
					deltaBase: 9,
					deltaShift: .125,
					loop: 1,
				...
				function Ht(e, t) {
					switch (this.env = e, this.stack = [], this.prog = t, e) {
						...
						case "prep": this.fv = this.pv = this.dpv = Mt, this.round = It;
					}
				}
				function zt(e) {
				...
				function Vt(e, t) {
					...
					let i, l;
					exports.DEBUG && console.log("SPVTL[" + e + "]", s, o), e ? (i = r.y - a.y, l = a.x - r.x) : (i = a.x - r.x, l = a.y - r.y), t.pv = t.dpv = Gt(i, l);
				}
				function Yt(e, t) {
					const n = t.stack, s = n.pop(), o = n.pop(), r = t.z2[s], a = t.z1[o];
					let i, l;
					exports.DEBUG && console.log("SFVTL[" + e + "]", s, o), e ? (i = r.y - a.y, l = a.x - r.x) : (i = a.x - r.x, l = a.y - r.y), t.fv = Gt(i, l);
				}
				function Zt(e) {
				...
				function Qt(e, t) {
					...
					e && (a = t.round(a)), o.setRelative(s, Ft, a, r), o.touch(s), t.rp0 = t.rp1 = n;
				}
				function Jt(e, t) {
				...
				function $t(e, t) {
					...
					do
						u !== o && r.setRelative(u, u, c, a), u = u.nextPointOnContour;
					while (u !== l);
				}
				function en(e, t) {
				...
				function nn(e, t) {
					...
					e && (Math.abs(u - l) < t.cvCutIn && (u = l), u = t.round(u)), a.setRelative(r, Ft, u, i), 0 === t.zp0 && (r.xo = r.x, r.yo = r.y), a.touch(r), t.rp0 = t.rp1 = o;
				}
				function sn(e, t) {
					const n = t.stack, s = n.pop(), o = t.z2[s];
					exports.DEBUG && console.log(t.step, "GC[" + e + "]", s), n.push(64 * t.dpv.distance(o, Ft, e, !1));
				}
				function on(e, t) {
				...
				function un(e, t) {
					const n = t.stack, s = n.pop(), o = n.pop(), r = t.z2[s], a = t.z1[o];
					let i, l;
					exports.DEBUG && console.log(t.step, "SDPVTL[" + e + "]", s, o), e ? (i = r.y - a.y, l = a.x - r.x) : (i = a.x - r.x, l = a.y - r.y), t.dpv = Gt(i, l);
				}
				function cn(e, t) {
				...
				wt.prototype.exec = function(e, t) {
					...
					if (!s || s.ppem !== t) {
						...
						if (!e) {
							Ht.prototype = _t, e = this._fpgmState = new Ht("fpgm", n.tables.fpgm), e.funcs = [], e.font = n, exports.DEBUG && (console.log("---EXEC FPGM---"), e.step = -1);
							try {
								kt(e);
							} catch (e) {
						...
						Ht.prototype = e, s = this._prepState = new Ht("prep", n.tables.prep), s.ppem = t;
					...
					if (Ht.prototype = t, i) {
						...
						for (let e = 0; e < i.length; e++) {
							...
							a = new Ht("glyf", u.instructions), exports.DEBUG && (console.log("---EXEC COMP " + e + "---"), a.step = -1), Et(u, a, n, s);
						...
						e.instructions && !a.inhibitGridFit && (a = new Ht("glyf", e.instructions), a.gZone = a.z0 = a.z1 = a.z2 = r, a.contours = o, r.push(new Nt(0, 0), new Nt(Math.round(e.advanceWidth * n), 0)), exports.DEBUG && (console.log("---EXEC COMPOSITE---"), a.step = -1), kt(a), r.length -= 2);
					} else a = new Ht("glyf", e.instructions), exports.DEBUG && (console.log("---EXEC GLYPH---"), a.step = -1), Et(e, a, n, s), r = a.gZone;
					return r;
				}, Et = function(e, t, n, s) {
					const o = e.points || [], r = o.length, a = t.gZone = t.z0 = t.z1 = t.z2 = [], i = t.contours = [];
					let l, u, c;
					for (let e = 0; e < r; e++) l = o[e], a[e] = new Nt(l.x * n, l.y * s, l.lastPointOfContour, l.onCurve);
					...
					if (!t.inhibitGridFit) {
						...
						if (a.push(new Nt(0, 0), new Nt(Math.round(e.advanceWidth * n), 0)), kt(t), a.length -= 2, exports.DEBUG) {
					...
					for (e.ip = 0; e.ip < n; e.ip++) {
						if (exports.DEBUG && e.step++, s = Ut[t[e.ip]], !s) throw new Error("unknown instruction: 0x" + Number(t[e.ip]).toString(16));
						s(e);
					}
				}, Ut = [
					qt.bind(void 0, At),
					...
					function(e) {
						...
						exports.DEBUG && console.log(e.step, "SPVFS[]", n, s), e.pv = e.dpv = Gt(s, n);
					},
					function(e) {
						const t = e.stack, n = t.pop(), s = t.pop();
						exports.DEBUG && console.log(e.step, "SPVFS[]", n, s), e.fv = Gt(s, n);
					},
					function(e) {
					...
					function(e) {
						...
						const d = u.x, g = u.y, m = c.x, y = c.y, v = p.x, b = p.y, x = f.x, S = f.y, U = (d - m) * (b - S) - (g - y) * (v - x), k = d * y - g * m, T = v * S - b * x;
						h.x = (k * (v - x) - T * (d - m)) / U, h.y = (k * (b - S) - T * (g - y)) / U;
					},
					function(e) {
					...
					function(e) {
						exports.DEBUG && console.log(e.step, "RTHG[]"), e.round = Lt;
					},
					function(e) {
						const t = e.stack.pop();
					...
					function(e) {
						...
						e.prog = e.funcs[n];
						for (let t = 0; t < s; t++) kt(e), exports.DEBUG && console.log(++e.step, t + 1 < s ? "next loopcall" : "done loopcall", t);
						e.ip = o, e.prog = r;
					},
					function(e) {
						const t = e.stack.pop();
						...
						e.prog = e.funcs[t], kt(e), e.ip = n, e.prog = s, exports.DEBUG && console.log(++e.step, "returning from", t);
					},
					function(e) {
					...
					function(e) {
						exports.DEBUG && console.log(e.step, "RTDG[]"), e.round = Rt;
					},
					nn.bind(void 0, 0),
					nn.bind(void 0, 1),
					function(e) {
					...
					function(e) {
						let t = e.stack.pop();
						exports.DEBUG && console.log(e.step, "IF[]", t), t || (Wt(e, !0), exports.DEBUG && console.log(e.step, "EIF[]"));
					},
					function(e) {
					...
					function(e) {
						let t, n = e.stack.pop();
						switch (exports.DEBUG && console.log(e.step, "SROUND[]", n), e.round = Dt, 192 & n) {
							case 0:
								t = .5;
								break;
							case 64:
					...
					function(e) {
						let t, n = e.stack.pop();
						switch (exports.DEBUG && console.log(e.step, "S45ROUND[]", n), e.round = Dt, 192 & n) {
							case 0:
								t = Math.sqrt(2) / 2;
								break;
							case 64:
					...
					void 0,
					function(e) {
						exports.DEBUG && console.log(e.step, "ROFF[]"), e.round = Ot;
					},
					void 0,
					function(e) {
						exports.DEBUG && console.log(e.step, "RUTG[]"), e.round = Bt;
					},
					function(e) {
						exports.DEBUG && console.log(e.step, "RDTG[]"), e.round = Ct;
					},
					Zt,
					Zt,
					void 0,
				...
				const hn = wt;
				function dn(e) {
					(e = e || {}).empty || (St(e.familyName, "When creating a new Font object, familyName is required."), St(e.styleName, "When creating a new Font object, styleName is required."), St(e.unitsPerEm, "When creating a new Font object, unitsPerEm is required."), St(e.ascender, "When creating a new Font object, ascender is required."), St(e.descender, "When creating a new Font object, descender is required."), St(e.descender < 0, "Descender should be negative (e.g. -512)."), this.names = {
					...
					} }), this.supported = !0, this.glyphs = new ce.GlyphSet(this, e.glyphs || []), this.encoding = new Z(this), this.position = new gt(this), this.substitution = new bt(this), this.tables = this.tables || {}, Object.defineProperty(this, "hinting", { get: function() {
					...
					if ("undefined" != typeof window) window.requestFileSystem = window.requestFileSystem || window.webkitRequestFileSystem, window.requestFileSystem(window.TEMPORARY, o.byteLength, (function(t) {
						t.root.getFile(e, { create: !0 }, (function(e) {
							e.createWriter((function(t) {
								const n = new DataView(o), s = new Blob([n], { type: "font/opentype" });
				...
				const Sn = {
					make: function(e, t) {
						...
						for (let s = 0; s < e.axes.length; s++) n.fields = n.fields.concat(yn(s, e.axes[s], t));
						for (let s = 0; s < e.instances.length; s++) n.fields = n.fields.concat(bn(s, e.instances[s], e.axes, t));
						return n;
					},
					parse: function(e, t, n) {
				...
				function Bn(e) {
					let t, n;
					const s = new gn({ empty: !0 }), o = new DataView(e, 0);
					let r, a = [];
					const i = z.getTag(o, 0);
					if (i === String.fromCharCode(0, 1, 0, 0) || "true" === i || "typ1" === i) s.outlinesFormat = "truetype", r = z.getUShort(o, 4), a = Rn(o, r);
					else if ("OTTO" === i) s.outlinesFormat = "cff", r = z.getUShort(o, 4), a = Rn(o, r);
					else {
					...
					for (let e = 0; e < r; e += 1) {
						...
						switch (r.tag) {
							case "cmap":
								i = Ln(o, r), s.tables.cmap = q.parse(i.data, i.offset), s.encoding = new Q(s.tables.cmap);
								break;
							case "cvt ":
								i = Ln(o, r), v = new z.Parser(i.data, i.offset), s.tables.cvt = v.parseShortList(r.length / 2);
								break;
							case "fvar":
								u = r;
								break;
							case "fpgm":
								i = Ln(o, r), v = new z.Parser(i.data, i.offset), s.tables.fpgm = v.parseByteList(r.length);
								break;
							case "head":
								i = Ln(o, r), s.tables.head = Le.parse(i.data, i.offset), s.unitsPerEm = s.tables.head.unitsPerEm, t = s.tables.head.indexToLocFormat;
								break;
							case "hhea":
								i = Ln(o, r), s.tables.hhea = Be.parse(i.data, i.offset), s.ascender = s.tables.hhea.ascender, s.descender = s.tables.hhea.descender, s.numberOfHMetrics = s.tables.hhea.numberOfHMetrics;
								break;
							case "hmtx":
								h = r;
								break;
							case "ltag":
								...
								break;
							case "maxp":
								i = Ln(o, r), s.tables.maxp = Me.parse(i.data, i.offset), s.numGlyphs = s.tables.maxp.numGlyphs;
								break;
							case "name":
								m = r;
								break;
							case "OS/2":
								...
								break;
							case "post":
								i = Ln(o, r), s.tables.post = Qe.parse(i.data, i.offset), s.glyphNames = new K(s.tables.post);
								break;
							case "prep":
								i = Ln(o, r), v = new z.Parser(i.data, i.offset), s.tables.prep = v.parseByteList(r.length);
								break;
							case "glyf":
								c = r;
								break;
					...
					const b = Ln(o, m);
					if (s.tables.name = Ve.parse(b.data, b.offset, n), s.names = s.tables.name, c && g) {
						const e = 0 === t, n = Ln(o, g), r = wn.parse(n.data, n.offset, s.numGlyphs, e), a = Ln(o, c);
					...
					const x = Ln(o, h);
					if (Ce.parse(x.data, x.offset, s.numberOfHMetrics, s.numGlyphs, s.glyphs), function(e) {
						let t;
					...
					if (y) {
						const e = Ln(o, y);
						s.tables.meta = tt.parse(e.data, e.offset), s.metas = s.tables.meta;
					}
					return s;
				}
				function Cn(e, t) {
			...
			896: (e, t, n) => {
				...
				class o extends s.Writable {
					...
					_destroy(e, t) {
						...
						for (const t of this._waiters) t.reject(e || /* @__PURE__ */ new Error("stream destroyed"));
						this._waiters = [], this._closed = !0;
					}
					_final(e) {
						this._processTrigger = void 0;
						for (const e of this._waiters) e.reject(/* @__PURE__ */ new Error("not enough data in stream"));
						this._waiters = [], this._closed = !0;
					}
					read(e) {
						return new Promise(((t, n) => {
							this._closed && n(/* @__PURE__ */ new Error("stream is closed")), this._waiters.push({
								resolve: t,
								reject: n,
								size: e,
								skip: !1
			...
			311: (e) => {
				...
				var s = new t(), o = new t(), r = /* @__PURE__ */ new Uint8Array(30), a = /* @__PURE__ */ new Uint16Array(30), i = /* @__PURE__ */ new Uint8Array(30), l = /* @__PURE__ */ new Uint16Array(30), u = new Uint8Array([
					16,
					17,
					18,
					0,
					...
					1,
					15
				]), c = new t(), p = /* @__PURE__ */ new Uint8Array(320);
				function f(e, t, n, s) {
					var o, r;
					for (o = 0; o < n; ++o) e[o] = 0;
				...
				function y(e, t) {
					...
					do
						s = 2 * s + (1 & r), r >>>= 1, ++o, n += t.table[o], s -= t.table[o];
					while (s >= 0);
				...
				t.default = async function(e, t) {
					...
					if (!r) {
						if ("undefined" != typeof navigator && "fonts" in navigator) {
							try {
								const e = await (null === (i = (n = navigator.permissions).request) || void 0 === i ? void 0 : i.call(n, { name: "local-fonts" }));
					...
					for (const n of (0, o.default)(e)) {
						...
						if (l.hasOwnProperty(n) && l[n].length > 0) {
							const e = l[n][0];
							if ("blob" in e) {
								const o = await (await e.blob()).arrayBuffer();
			...
			833: (e, t, n) => {
				"use strict";
				Object.defineProperty(t, "__esModule", { value: !0 }), t.enableLigatures = void 0;
				const s = n(109);
					...
					return e.registerCharacterJoiner(((i) => {
						...
						if (l && (0 === a || n !== l)) {
							...
							(0, s.default)(t, 1e5).then(((n) => {
								...
								t === e.options.fontFamily && (a = 3, "debug" === e.options.logLevel && console.debug(r, /* @__PURE__ */ new Error("Failure while loading font")), o = void 0, r = n);
							}));
						}
						return o && 2 === a ? o.findLigatureRanges(i).map(((e) => [e[0], e[1]])) : function(e, t) {
							const n = [];
							for (let s = 0; s < e.length; s++) for (let o = 0; o < t.length; o++) if (e.startsWith(t[o], s)) {
								n.push([s, s + t[o].length]), s += t[o].length - 1;
								break;
							}
							return n;
						}(i, t);
					...
					for (; e.offset < e.input.length;) {
						...
						if (n) /[\dA-Fa-f]/.test(s) ? (e.offset--, t += o(e)) : t += s, n = !1;
							...
							case "\\":
								...
								break;
							case ",": return t;
							default: /\s/.test(s) ? t.endsWith(" ") || (t += " ") : t += s;
						}
					}
					return t;
				}
					...
					for (; t.offset < t.input.length;) {
						...
						switch (e) {
							...
							case ",":
								o.push(r), r = "";
								break;
							default: /\s/.test(e) || (t.offset--, r += s(t), o.push(r), r = "");
						}
					}
					return o;
				};

...
// to the operator is settled elsewhere and does not touch this grammar: session
// notification (`internal/notify`) fires an OS notification and marks the tab's own
// card, and deliberately adds nothing to a space row.
